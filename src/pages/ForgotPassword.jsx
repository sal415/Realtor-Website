            ...
            <div className='w-full md:w-[67%] lg:w-[40%] lg:ml-20'> 
                <form> 
                    ...
                    <div className=' flex justify-between whitespace-nowrap text-sm sm:text-lg'>
                        ...
                        <p>
                            <Link to="/sign-in" className='text-red-500 hover:text-red-600 duration-200'>Sign In instead </Link>
                        </p>
                    </div>
                <button type="submit" className='w-full hover:bg-blue-600 text-white px-7 py-3 text-sm font-medium uppercase rounded shadow-md bg-slate-500 transition duration-150 ease-in-out hover:shadow-xl active:bg-blue-900'>Send reset password </button>
